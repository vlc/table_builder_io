...
from csv_test_cases import (
    ...
    MULTILEVEL_MULTIINDEX_EXPECTED, MUTTILEVEL_RAGGED_FFILL_TEST, FILTERS_2021_DATA_TEST_DATA,
)
...
TESTS = [MULTILEVEL_ROWS_TEST_DATA, MULTILEVEL_ROWS2_TEST_DATA, SPATIAL_X_ATTR1_TEST_DATA,
         OD_DATA1_TEST_DATA, COL_MULTIINDEX_DATA_TEST_DATA, FILTERS_2021_DATA_TEST_DATA]
